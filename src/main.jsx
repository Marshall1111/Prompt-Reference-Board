...
const BODY_BOOK_THEME_EFFECT_SAMPLES = {
  ...
  kindergarten: [
    { label: "手账绘本封面", src: "/body-book-samples/effects/kindergarten-cover.png", type: "cover" },
    { label: "入园故事内页", src: "/body-book-samples/effects/kindergarten-page-01.png", type: "baby" }
  ]
};
